...
const rotatePics = () => {
  ...
  setInterval(function () {
    if (i === 1) {
      ...
      titleSummer.innerHTML = `Average temperature between June and August, 1986-2005`
      titleWinter.innerHTML = `Average temperature between December and February, 1986-2005`
    } else {
      const picsToShow = document.querySelectorAll(`.impact-${i}`);
      picsToShow.forEach(el => el.style.zIndex = i)
      titleWinter.innerHTML = i === 2 ? `Average temperature between December and February, 2020-2039` : `Average temperature between December and February, 2040-2059`;
      titleSummer.innerHTML = i === 2 ? `Average temperature between June and August, 2020-2039` : `Average temperature between June and August, 2040-2059`;
    }
    i = (i === len) ? 1 : ++i;
  }, 1500);
};
